...
export default function CurrencyList({ currencies }) {
  return (
    ...
    >
      {/* Column headers */}
      <div className="grid grid-cols-[24px_1fr_auto_auto_auto] items-center gap-4 px-4 py-3 border-b border-white/10 text-xs font-semibold text-gray-500 uppercase tracking-wide">
        <span>#</span>
        <span>Asset</span>
